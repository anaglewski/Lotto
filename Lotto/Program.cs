    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                do
                {
                    kumulacja = rnd.Next(2, 41) * 1000000;
                    dzien++;
                    int losow = 0;
                    ...
                    {
                        Console.WriteLine("Nie miałes losów w tym losowaniu");
                    }
        ...
        private static int[] PostawLos()
        {
            ...
            for (int i = 0; i < liczby.Length; i++)
            {
                ...
                {
                    Console.WriteLine("Niestety, błedna liczba.");
                    i--;
                    Console.ReadKey();
                }
            }
